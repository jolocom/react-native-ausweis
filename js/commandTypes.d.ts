...
import { AccessRightsFields, CardInfo, ScannerMessages, SimulatorData } from './types';
...
export declare const disruptiveCommands: Commands[];
...
export type Handler<T extends Message, R extends Message = T> = (message: T | R, eventHandlers: Partial<EventHandlers>, callbacks: {
    resolve: Function;
    reject: Function;
}) => T | R | void;
...
export interface CommandDefinition<T extends Message = Message, R extends Message = Message> extends VoidCommandDefinition {
...
export interface GetInfoCommand<T extends Message> extends CommandDefinition<T> {
    command: {
        cmd: Commands.getInfo;
    };
}
export interface GetStatusCommand<T extends Message> extends CommandDefinition<T> {
    command: {
        cmd: Commands.getStatus;
    };
}
export interface SetAPILevelCommand<T extends Message> extends CommandDefinition<T> {
    command: {
        cmd: Commands.setAPILevel;
        level: number;
    };
}
export interface GetAPILevelCommand<T extends Message> extends CommandDefinition<T> {
    command: {
        cmd: Commands.getAPILevel;
    };
}
export interface GetReaderCommand<T extends Message> extends CommandDefinition<T> {
    command: {
        cmd: Commands.getReader;
        name: string;
    };
}
export interface GetReaderListCommand<T extends Message> extends CommandDefinition<T> {
    command: {
        cmd: Commands.getReaderList;
    };
}
export interface RunAuthCommand<T extends Message, R extends Message> extends CommandDefinition<T, R> {
    command: {
...
export interface ChangePinCommand<T extends Message, R extends Message> extends CommandDefinition<T, R> {
    command: {
...
export interface GetAccessRightsCommand<T extends Message> extends CommandDefinition<T> {
    command: {
        cmd: Commands.getAccessRights;
    };
}
export interface SetAccessRightsCommand<T extends Message> extends CommandDefinition<T> {
    command: {
...
export interface GetCertificateCommand<T extends Message> extends CommandDefinition<T> {
    command: {
        cmd: Commands.getCertificate;
    };
}
export interface CancelCommand<T extends Message, R extends Message> extends CommandDefinition<T, R> {
    command: {
        cmd: Commands.cancel;
    };
}
export interface AcceptCommand<T extends Message, R extends Message> extends CommandDefinition<T, R> {
    command: {
        cmd: Commands.accept;
    };
}
...
export interface SetPinCommand<T extends Message, R extends Message> extends CommandDefinition<T, R> {
    command: {
        cmd: Commands.setPin;
...
export interface SetPukCommand<T extends Message, R extends Message> extends CommandDefinition<T, R> {
    command: {
        cmd: Commands.setPuk;
        value: string;
    };
